...
export default function SparklesPreview() {
    return (
        <div className="h-screen w-full px-4 bg-black flex flex-col items-center justify-center overflow-hidden rounded-md">
            <h1 className="md:text-7xl text-3xl lg:text-9xl font-bold text-center text-white relative z-20">
                {`Dev</>Hub`}
            </h1>
            <p className="text-white">Cultivating Growth in the Digital Realm</p>
